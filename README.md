...
⋅⋅* Which arrays can be appended to by the client in as uncommitted so all clients see uncommitted items of that array until the blockchain gets around to committing them
